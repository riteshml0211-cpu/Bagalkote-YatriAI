        ...
        {!scanResult ? (
          <div className="max-w-3xl mx-auto">
            ...
            <div
              ...
              onDrop={handleDrop}
              className={`relative border-2 border-dashed rounded-2xl sm:rounded-3xl p-5 sm:p-12 text-center transition-all cursor-pointer group bg-white shadow-sm hover:shadow-md ${
                isDragging
            ...
            >
              ...
              {isScanning ? (
                <div className="py-6 sm:py-8 space-y-4">
                  ...
                  <div className="relative w-40 h-40 sm:w-48 sm:h-48 mx-auto rounded-2xl overflow-hidden border-2 border-amber-500 shadow-lg">
                    {selectedImage ? (
                  ...
                  <div className="flex items-center justify-center gap-2 text-amber-900 font-bold text-xs sm:text-base">
                ...
                <div className="space-y-3 sm:space-y-4 py-4 sm:py-6">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-2xl bg-amber-200 text-amber-900 flex items-center justify-center animate-bounce shadow-md">
                    <Upload className="w-8 h-8 sm:w-10 sm:h-10 text-amber-800" />
                  </div>
                  <div>
                    <h3 className="font-serif font-bold text-lg sm:text-xl text-amber-900">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="w-14 h-14 sm:w-20 sm:h-20 mx-auto rounded-2xl bg-amber-100 text-amber-800 flex items-center justify-center group-hover:scale-110 transition-transform shadow-xs">
                    <Upload className="w-7 h-7 sm:w-10 sm:h-10 text-amber-700" />
                  </div>
                  <div>
                    <h3 className="font-serif font-bold text-base sm:text-xl text-slate-800">
                      {t.scanner.dropTitle}
                    </h3>
                  ...
                  <div className="pt-1 sm:pt-2 flex justify-center">
                    <button
                      type="button"
                      className="px-4 sm:px-5 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-semibold text-xs sm:text-sm shadow-md transition-all active:scale-95 flex items-center gap-2 cursor-pointer"
                    >
            ...
            {errorMsg && (
              <div className="mt-4 p-3 rounded-xl bg-red-50 border border-red-200 text-red-700 text-xs sm:text-sm flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-8 gap-2 sm:gap-2.5">
                {PRESET_SAMPLES.map((sample) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] sm:text-[11px] font-semibold text-slate-800 group-hover:text-amber-900 line-clamp-2 leading-tight">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl sm:rounded-3xl border border-amber-200 shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
            {/* Result Header Bar */}
            <div className="bg-gradient-to-r from-stone-900 via-amber-950 to-stone-900 text-white px-4 sm:px-6 py-3 sm:py-4 flex flex-wrap items-center justify-between gap-2.5">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <span className="text-[11px] sm:text-xs bg-emerald-950/80 text-emerald-300 border border-emerald-500/40 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full font-bold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 items-start">
                ...
                <div className="md:col-span-5 space-y-3">
                  <div className="aspect-4/3 rounded-2xl overflow-hidden border border-slate-200 shadow-md relative">
                    ...
                    />
                    <div className="absolute bottom-2 left-2 bg-black/60 backdrop-blur-md px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] text-white flex items-center gap-1">
                      <Eye className="w-3 h-3 text-amber-400 shrink-0" />
                      <span className="truncate max-w-[200px]">{scanResult.location}</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-1 gap-2 pt-1">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs sm:text-sm shadow-md transition-all active:scale-95 cursor-pointer"
                    >
                ...
                <div className="md:col-span-7 space-y-4">
                  ...
                  {/* Metadata Chips Grid */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs bg-amber-50/50 p-3 sm:p-3.5 rounded-xl border border-amber-200/60">
                    <div>
                  ...
                  {/* Visitor Tip */}
                  <div className="bg-amber-100/60 border-l-4 border-amber-600 p-2.5 sm:p-3 rounded-r-xl text-xs text-amber-950">
